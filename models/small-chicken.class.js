...
class SmallChicken extends MovableObject {
  ...
  IMAGES_WALKING = [
    'img_pollo_loco/img/3_enemies_chicken/chicken_small/1_walk/1_w.png',
    'img_pollo_loco/img/3_enemies_chicken/chicken_small/1_walk/2_w.png',
    'img_pollo_loco/img/3_enemies_chicken/chicken_small/1_walk/3_w.png',
  ];

  IMAGES_DEAD = [
    'img_pollo_loco/img/3_enemies_chicken/chicken_small/2_dead/dead.png',
  ];
